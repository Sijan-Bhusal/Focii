...
import dev.sijan.focii.util.ScreenUsageHelper
...
object RoutineSessionManager {
    ...
    fun evaluateAndSync(context: Context) {
        val routines = dev.sijan.focii.routine.Routines.getAll()
    ...
    fun getActiveRoutineNames(): List<String> {
        ...
        return sessions.mapNotNull { session ->
            dev.sijan.focii.routine.Routines.get(session.routineId)?.name
        }
    }
