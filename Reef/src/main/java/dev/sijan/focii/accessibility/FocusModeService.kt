...
import dev.sijan.focii.App
import dev.sijan.focii.MainActivity
import dev.sijan.focii.R
import dev.sijan.focii.data.PhaseType
import dev.sijan.focii.data.SessionType
import dev.sijan.focii.timer.PomodoroConfig
import dev.sijan.focii.timer.PomodoroPhase
import dev.sijan.focii.timer.TimerSessionState
import dev.sijan.focii.timer.TimerStateManager
import dev.sijan.focii.util.*
...
class FocusModeService: Service() {
    ...
    companion object {
        ...
        const val ACTION_TIMER_UPDATED = "dev.sijan.focii.TIMER_UPDATED"
        const val ACTION_START = "dev.sijan.focii.START_TIMER"
        const val ACTION_PAUSE = "dev.sijan.focii.PAUSE_TIMER"
        const val ACTION_RESUME = "dev.sijan.focii.RESUME_TIMER"
        const val ACTION_RESTART = "dev.sijan.focii.RESTART_TIMER"
        const val ACTION_TAKE_BREAK = "dev.sijan.focii.TAKE_BREAK"
